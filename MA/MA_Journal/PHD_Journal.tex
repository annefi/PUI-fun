...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item Eigengeschwindigkeit einbauen \todo{Eigen-vel}
	\end{itemize}
...
Next: Achsenbegrenzung Eigengeschw. anpassen \todo{Achsen} und schauen, warum ich um 1995 doch eine kleine Abweichung zwischen ekl. und eq. Systemen (SPICE) hatte \todo{Abweichung}
%
%
%
\end{document}