...
\newdaytt{19}{01}
In \textit{spice\_ulysses\_new\_inheri.py} gibts schon comp-Funktionen. Allerdings funktioniert comp\_coords nicht in den Winkel-Komponenten \todo{comp\_coords fixen}
%
%
%
\end{document}