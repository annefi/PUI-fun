...
\begin{itemize}
	...
	\begin{itemize}
		...
		\item zurückgegeben werden dann \verb|norm_arr| (proportional zur absoluten Messzeit, "`wie oft hat das Instrument in eine Richtung geguckt"'; Erwartung: häufig entlang der Spinachse, als radial) und Histogramm ungewichtet.
		\item Plot erzeugen: \\
...
\begin{itemize}
	...
	Differenzen werden kleiner für größeren EpQ-Steps. Stimmt nicht ganz: Peaken bei einem mittleren EpQ-Step (abh. von vsw)\\
