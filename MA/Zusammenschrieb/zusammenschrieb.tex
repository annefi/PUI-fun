...
\section{ULYSSES}
	...
	\hline 
\end{tabular}
\footnotetext[1]{No values for \textit{Helioc. Rt. Asc.} and \textit{Solar Longitude wrt Earth} before 4.11.1990 and no values at all between 13.12.2001 and 31.12.2001}
\footnotetext[2]{Footnote}
...
\begin{itemize}
	...
	\item Ionen mit kleiner Masse UND kleiner Ladung sind anfälliger dafür unter den Threshold zu fallen (bei kleinen EpQs): Kleine Masse wegen $E \sim m$, kleine Ladung, weil die Nachbeschleunigung besser wirkt, je höher die Ladung.
