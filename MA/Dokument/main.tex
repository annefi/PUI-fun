...
A study of the evolution of the VDF helps us to understand the origin of PUI and their neutral's seed population and of the underlying effects that shape the VDF.
\\
...
\begin{abstractd}
	...
	Um diese Informationen über die Einflugrichtung korrekt in dreidimensionale Geschwindigkeitskomponenten zu überführen muss die Ausrichtung von Ulysses zu jedem Messzeitpunkt betrachtet werden.
	\\
	In dieser Arbeit verwenden wir einen virtuellen Detektor, um den Übergang von Ulysses SWICS \textit{Pulse Height Analysis}-Daten zu dreidimensionalen Geschwindigkeitskomponenten am Beispiel von $\mathrm{He^+}$ PUI durchzuführen.	
\end{abstractd}
