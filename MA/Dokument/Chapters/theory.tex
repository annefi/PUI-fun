...
However, observations by e.g. \citet{moebius_nature_85_98?todo} on $He+$ or \citet{gloeckler1995, todo} on TODO have shown clear anisotropic features in the measured VDFs.
Following studies (todo) explained these findings with an assumption of ineffective scattering of the PUI pitch-angle across $90^\circ$. The PA would only...hemisphere...todo.
\\ \\
Recent observations TODO have emphasized that the measured VDF of PUIs is mainly oriented perpendicular to the magnetic field. Thus, it is believed that the VDF's anisotropic features are remnants of the initial toroidal VDF. 
\\ \\
