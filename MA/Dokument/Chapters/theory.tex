...
\\ \\
Under the assumption that the particle is at rest (compared to vsw. Holds true for interstellar PUIs. Durchrechnen, warum das angemessen ist) and the HMF's orientation is perpendicular to the direction of vsw: relative motion between particle and HMF
\\ \\
ionization of particle: Lorentz force. Forced onto a gyro orbit perpendicular to the field line with Bahngeschwindigkeit vsw and at the same time bound to the field line. Total speed ranges from 0 to 2 vsw in a sun frame of reference
\\ \\
