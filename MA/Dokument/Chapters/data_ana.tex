...
This can be done by subtracting the instantaneous solar wind speed in R-component from a velocity in the spacecraft frame: 
\begin{align*}
...
\begin{figure}[h]
	...
	\centering
	\caption{todo: Kollimatorbegrenzung einzeichnen. \\
	w im sw-frame!}
	\label{fig:cov}
\end{figure}
\\
