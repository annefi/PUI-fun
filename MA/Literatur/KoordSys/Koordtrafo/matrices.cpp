...
//template Matrix2x2 &Matrix2x2::operator=<float>(const Matrix<2, 2, float> &other);
...
//template Matrix2x2 &Matrix2x2::operator=<double>(const Matrix<2, 2, double> &other);
...
//template Matrix3x3 &Matrix3x3::operator=<float>(const Matrix<3, 3, float> &other);
...
//template Matrix3x3 &Matrix3x3::operator=<double>(const Matrix<3, 3, double> &other);
...
//template Matrix4x4 &Matrix4x4::operator=<float>(const Matrix<4, 4, float> &other);
//template Matrix4x4 &Matrix4x4::operator=<double>(const Matrix<4, 4, double> &other);
...
//template Matrix5x5 &Matrix5x5::operator=<float>(const Matrix<5, 5, float> &other);
...
//template Matrix5x5 &Matrix5x5::operator=<double>(const Matrix<5, 5, double> &other);
