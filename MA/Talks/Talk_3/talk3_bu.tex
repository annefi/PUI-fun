...
%\vspace{-0.5cm}
	\begin{figure}
		\includegraphics[scale=0.35]{Pics/ulysses_trajectory.pdf}
			\caption{\tiny{\begin{center}
...
\begin{columns}
	...
	\end{center}
	\column[]{6cm}
	\includegraphics[scale=0.2]{Pics/RTN.pdf}
\end{columns}
...
\begin{frame}{EpQ measurement}
	...
	\begin{columns}
		...
		\only<3>{\vspace{-0.5cm}\includegraphics[scale=0.2]{Pics/sw_pui_gloeckler.png}
		\caption{\tiny{\begin{flushright}
					\textit{Gloeckler, Geiss et al., 1992}\end{flushright}}}}
				
		\end{figure}
		\column{4cm}
		\only<1>{\includegraphics[scale=0.22]{Pics/swics_collimator111.pdf}}
		\only<2,3>{\includegraphics[scale=0.22]{Pics/swics_collimator22.pdf}}
	\end{columns}
\vspace{-0.5cm}
	\begin{itemize}
