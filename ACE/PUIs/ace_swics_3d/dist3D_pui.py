...
class Dist3D(object):
    def __init__(self,d,mass = 4., charge = 1., aspphistep=1.,aspthetastep=1.,nrs_perp=1,nrs_para=3,nrs_sec=3,nrs_epq=3,vswbins=arange(300.,800.1,10.),ion="He1+"):
        """
    ...
    def calc_w3dspecs(self,vswbins=arange(500.,800.1,10.),wxbins=arange(-2.,2.01,0.2),wybins=arange(-2.,2.01,0.2),wzbins=arange(-2.,2.01,0.2),min_whe=0.9,aspphi=(-20.,20.)):
        ...
        #res = zeros((wxbins.shape[0],wybins.shape[0],wzbins.shape[0])
        for iv,v in enumerate(vswbins[:-1]):
            print iv,v
            for ip,p in enumerate(self.aspphi[:-1]):
