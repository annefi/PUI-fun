      subroutine dedxgold(zion,mion,energy,bw)
...
c++++ Starting read-in of the dE/dx data +++++++++++++++++++++     
        ...
        if (zion .eq. 1) then
            OPEN( UNIT=10, FILE='./deadlayer/hydrogengold.f')
            do i=1,79
...
c                write(*,*), (brain(i,j),j=1,6)
        ...
        if (zion .eq. 2) then
            if (nint(mion) .eq. 4) then
                OPEN( UNIT=10, FILE='./deadlayer/heliumgold.f')
                do i=1,79
                    READ(10,*,END=9999), (brain(i,j),j=1,6)
c                    write(*,*), (brain(i,j),j=1,6)
                end do
            else if (nint(mion) .eq. 3) then
                OPEN( UNIT=10, FILE='./deadlayer/3heliumgold.f')
                do i=1,79
                    READ(10,*,END=9999), (brain(i,j),j=1,6)
c                    write(*,*), (brain(i,j),j=1,6)
                end do
        ...
        if (zion .eq. 6) then
            if (nint(mion) .eq. 12) then
                OPEN( UNIT=10, FILE='./deadlayer/carbongold.f')
                do i=1,79
                    READ(10,*,END=9999), (brain(i,j),j=1,6)
c                    write(*,*), (brain(i,j),j=1,6)
                end do
            else if (nint(mion) .eq. 13) then
                OPEN( UNIT=10, FILE='./deadlayer/13carbongold.f')
                do i=1,79
                    READ(10,*,END=9999), (brain(i,j),j=1,6)
c                    write(*,*), (brain(i,j),j=1,6)
                end do
        ...
        if (zion .eq. 7) then
            OPEN( UNIT=10, FILE='./deadlayer/nitrogengold.f')
            do i=1,79
                READ(10,*,END=9999), (brain(i,j),j=1,6)
c                write(*,*), (brain(i,j),j=1,6)
            end do
        ...
        if (zion .eq. 8) then
            OPEN( UNIT=10, FILE='./deadlayer/oxygengold.f')
            do i=1,79
                READ(10,*,END=9999), (brain(i,j),j=1,6)
c                write(*,*), (brain(i,j),j=1,6)
            end do
        ...
        if (zion .eq. 10) then
            OPEN( UNIT=10, FILE='./deadlayer/neongold.f')
            do i=1,79
                READ(10,*,END=9999), (brain(i,j),j=1,6)
c                write(*,*), (brain(i,j),j=1,6)
            end do
        ...
        if (zion .eq. 12) then
            OPEN( UNIT=10, FILE='./deadlayer/magnesiumgold.f')
            do i=1,79
                READ(10,*,END=9999), (brain(i,j),j=1,6)
c                write(*,*), (brain(i,j),j=1,6)
            end do
        ...
        if (zion .eq. 13) then
            OPEN( UNIT=10, FILE='./deadlayer/aluminumgold.f')
            do i=1,79
                READ(10,*,END=9999), (brain(i,j),j=1,6)
c                write(*,*), (brain(i,j),j=1,6)
            end do
        ...
        if (zion .eq. 14) then
            OPEN( UNIT=10, FILE='./deadlayer/silicongold.f')
            do i=1,79
                READ(10,*,END=9999), (brain(i,j),j=1,6)
c                write(*,*), (brain(i,j),j=1,6)
            end do
        ...
        if (zion .eq. 16) then
            OPEN( UNIT=10, FILE='./deadlayer/sulfurgold.f')
            do i=1,79
                READ(10,*,END=9999), (brain(i,j),j=1,6)
c                write(*,*), (brain(i,j),j=1,6)
            end do
        ...
        if (zion .eq. 18) then
            OPEN( UNIT=10, FILE='./deadlayer/argongold.f')
            do i=1,79
                READ(10,*,END=9999), (brain(i,j),j=1,6)
c                write(*,*), (brain(i,j),j=1,6)
            end do
        ...
        if (zion .eq. 20) then
            OPEN( UNIT=10, FILE='./deadlayer/calciumgold.f')
            do i=1,79
                READ(10,*,END=9999), (brain(i,j),j=1,6)
c                write(*,*), (brain(i,j),j=1,6)
            end do
        ...
        if (zion .eq. 26) then
            OPEN( UNIT=10, FILE='./deadlayer/irongold.f')
            do i=1,79
                READ(10,*,END=9999), (brain(i,j),j=1,6)
c                write(*,*), (brain(i,j),j=1,6)
            end do
        ...
        if (zion .eq. 36) then
            OPEN( UNIT=10, FILE='./deadlayer/kryptongold.f')
            do i=1,79
                READ(10,*,END=9999), (brain(i,j),j=1,6)
c                write(*,*), (brain(i,j),j=1,6)
            end do
