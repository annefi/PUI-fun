c ***********************************************************************
       ...
       SUBROUTINE GEOMETRIESCAN(c,beta,entry_angle)
...
c     .         7.42,  7.45,  7.29/     !z-component of corner 4 for det 1,2,3  
     ...
     .         8.83,  8.83,  8.66/     !z-component of corner 4 for det 1,2,3 
        ...
        run2 = 1                    ! Read the E/q steps and runconfig.dat
        run3 = 0                    ! Test run for swxeff
        run4 = 0                    ! Run for all elements in param/parameters #
        run5 = 0                    ! Test run for random noise
        run6 = 0                    ! Run for error estimation (random noise)
        run7 = 1                    ! Monte Carlo Integration
        run8 = 0                    ! Different experiments
...
c        ENTRY_ANGLE = 1.36                     ! may need to be varied
        ...
        c(1) = 71.*cos(beta)                   ! entry point in C-foil
        c(2) = 71.*sin(beta)                   ! modify if trajectory modelling 
        c(3) = 0.0                             ! shows c(3) <> 0 !!!!!
