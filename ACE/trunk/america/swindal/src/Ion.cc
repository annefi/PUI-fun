/*
  ...
  $Id: Ion.cc,v 1.5 2005/03/24 21:34:15 jraines Exp $
...
void Ion::print(void){
  cout << "name=" << name << " element=" << element 
       ...
       << " PrGaussCutoff=" << PrGaussCutoff << endl;
  errlvl.dump();
...
Ion::Ion(const string i_name, const string i_element, 
...
Ion::Ion(const Ion& ion){
  ...
  mass = ion.mass;
  charge = ion.charge;
  PrGaussCutoff = ion.PrGaussCutoff;
