...
# Ionen für den "all_under_he_speed"-fit
ions=["He2","O8","N7","C6","13C6","O7","N6","C5","Mg10","Ne8","O6","N5"]
...
if (1):
    ...
    for step in range(40,50):
        ...
        filex=open("/data/wimmer/mu/jahresdaten/all_data/step_files/all_under_he_speed+2/step_"+str(step)+"_o_cme")
        ...
        for rn in range(1):
            if(1 == 1): 
                ...
                for i in range(3):
                    ...
                    gp("fit s(x,y) '/data/wimmer/mu/jahresdaten/all_data/step_files/all_under_he_speed+2/step_"+str(step)+"_o_cme' u 1:2:3:4 via Ge1,Ge2,Ge3,sge")
                    ...
                    #gp("fit s(x,y) '/data/wimmer/mu/jahresdaten/all_data/step_files/all_under_he_speed/step_"+str(step)+"_o_cme' u 1:2:3:4 via Ge6,Ge7,Ge8,Ge9,Ge10,Ge11,Ge12,Ge13")
                    ...
                    gp("fit s(x,y) '/data/wimmer/mu/jahresdaten/all_data/step_files/all_under_he_speed+2/step_"+str(step)+"_o_cme' u 1:2:3:4 via "+fp)
                ...
                gp("splot s(x,y), '/data/wimmer/mu/jahresdaten/all_data/step_files/all_under_he_speed+2/step_"+str(step)+"_o_cme' u 1:2:3:4 with errorbars")
