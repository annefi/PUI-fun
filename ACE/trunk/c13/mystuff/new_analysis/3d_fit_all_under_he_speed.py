        ...
        for rn in range(1):
            if(1 == 1): 
                ...
                for i in range(3):
                    ...
                    gp("fit s(x,y) '/data/wimmer/mu/jahresdaten/all_data/step_files/all_under_he_speed+2/step_"+str(step+1)+"_o_cme' u 1:2:3:4 via Ge1,Ge2,Ge3,sge")
                    gp("set yrange["+str(int(tp[3,0]-8))+":"+str(tp[3,0]+35)+"]")
                    gp("fit s(x,y) '/data/wimmer/mu/jahresdaten/all_data/step_files/all_under_he_speed+2/step_"+str(step+1)+"_o_cme' u 1:2:3:4 via "+fp)
                gp("set isosamples 50")
                gp("splot s(x,y), '/data/wimmer/mu/jahresdaten/all_data/step_files/all_under_he_speed+2/step_"+str(step+1)+"_o_cme' u 1:2:3:4 with errorbars")
