...
ll=0
sum=0.
system("rm hsf_results/linear/all/hsf_all")
...
if (1):
    ...
    #        epqstep=i
    #print epqstep
    file1=open("hsf_results/linear/all/hsf_all","a")
    ...
    for step in range(20,58):
        if(1==1):
            ...
            for i in range(10):
                ...
                gp("fit s(x,y) '/data/wimmer/mu/jahresdaten/all_data/step_files/all/step_"+str(step)+"_o_cme' u 1:2:3:4 via Ge3")
                gp("fit s(x,y) '/data/wimmer/mu/jahresdaten/all_data/step_files/all/step_"+str(step)+"_o_cme' u 1:2:3:4 via Ge3,xkt3,xge3,sktr3,sktl3,sge3,ksr1,ksr2,ksl2")
...
file3=open("/home/kleopatra/mu/Desktop/tof_cal/2_4_2_239_25")
l=0
for i in file3:
    x=i.split()
    tof[l]=float(x[3])
...
file2=open("hsf_results/linear/all/hsf_all_ave","w")
for i in range(58):
    file2.write(str(i))
    file2.write("   ")
