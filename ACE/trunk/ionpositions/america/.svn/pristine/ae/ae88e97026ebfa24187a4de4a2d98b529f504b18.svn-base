...
; $Id: xfmexp.pro,v 1.4 2004/10/19 13:47:29 jraines Exp $
;
...
;   WARNING:  This works, but is of questionable use.
;   A linear fit between Etilde and picked ESD is more logical.
;
; Author(s): Jim Raines (jmr)
;
; Method:
