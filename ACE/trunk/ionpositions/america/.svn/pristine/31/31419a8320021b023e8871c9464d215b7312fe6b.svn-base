...
/* NOTE:  swindal.h not included because some stl stuff conflicts with
   NR routines.
*/
// standard library
#include <iostream>
...
/* Numerical Recipes
   Note: the svdcmp prototype was extracted from nr.h and included
   here because nr.h caused conflicts with a system routine.
*/
extern "C"{
#include "nrutil.h"
