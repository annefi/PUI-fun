...
/* --- prototypes for functions in a3goa.c --- */
...
/* %subsubsection "HSEb Velocity Components" */
/* get HSEb x component of velocity */
extern float a3goa_vel_HSEb_x(double ss1970);
/* get HSEb y component of velocity */
extern float a3goa_vel_HSEb_y(double ss1970);
/* get HSEb z component of velocity */
extern float a3goa_vel_HSEb_z(double ss1970);
