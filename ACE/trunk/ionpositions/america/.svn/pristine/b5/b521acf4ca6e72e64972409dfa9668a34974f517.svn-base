...
char *argv[];
{
  ...
  if( init_rd_swepam_dsti(hdf_fp, SD_id, "r") <= 0) {
    fprintf(stderr,"No swepam dsti data\n");
    exit(-1);
  }

  /* read and print data */
  ii=0;
  while((retval=read_swepam_dsti(&testdata,ii))!=-1) {
