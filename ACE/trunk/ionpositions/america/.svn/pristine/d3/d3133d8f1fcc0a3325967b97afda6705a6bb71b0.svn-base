; $Id: bar_plot_pos.pro,v 1.1 2005/03/14 16:53:39 jraines Exp $
;
; Copyright (c) 1990-2000, Research Systems, Inc.  All rights reserved.
;	Unauthorized reproduction prohibited.
;

pro bar_plot_pos,values,baselines=baselines,colors=colors,barnames=barnames, $
...
;
;     POSITION: Specify position of plot.  See 'PLOT' procedure for details.
;
; OUTPUTS:
...
;
;       04Dec2003, Jim Raines, Univ. of Michigan, Added position keyword.
;-
if (n_params(d) eq 0) then begin  ;Print call & return if no parameters
  ...
  print,' rotate=rotate, position=position'
  return
endif
