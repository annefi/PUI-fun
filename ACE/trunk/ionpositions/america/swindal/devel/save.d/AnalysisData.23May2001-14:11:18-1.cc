...
AnalysisData::AnalysisData(void){
  ...
  //int Global::gDbgLvl;
  using namespace Global;  // get rid of this
  int DbgLvl = Global::gDbgLvl;      // Set local debug level to global level
 ...
 // Sulfur
  ...
  Global::CurLv1File = "/home/acedata/LV1/2000/2000158.nc";

  strcpy(acelv1file, Global::CurLv1File.c_str());
