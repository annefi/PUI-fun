/*
  ...
  Description:
    Class containing data an functions for individual PHA words.
  ...
  Method:
    ...
    directly as friends or with get's.
...
public:
  ...
  double tofch2tof(int);
  int    tof2tofch(double);
  
  double esdch2esd(int);
  int    esd2esdch(double);
