...
int loadPha(vector<Pha> *pha, int AnalysisInterval){
  ...
  // misc. counters
  int ncycle=0;          // number of cycles successfully processed
...
//       }
    ...
    ncycle++;  // increment counter *after* successfully processing cycle
