...
char *argv[];
{
  ...
  if( init_rd_swepam_dsti2(hdf_fp, SD_id, "r") <= 0) {
    fprintf(stderr,"No swepam dsti2 data\n");
    exit(-1);
  }

  /* read and print data */
  ii=0;
  while((retval=read_swepam_dsti2(&testdata,ii))!=-1) {
