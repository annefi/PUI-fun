...
int32 vgrp_id_schskp_out;
static int32 vdata_id_schskp_out;

  /* 9995 is the size of schskp.h + 1 added line */
char Vgrp_descrp_schskp_outData[9995];

/****----  init create function  ----****/

int32 init_cr_schskp_out(int32 hdf_fp, int32 sd_id, int32 an_id, char *classname)
{
  int32 retval=0;
  int32 vgrp_ref_w;
  int32 ann_id_w;
  int32 wr_Vgrp_desc_schskp_out();

  void print_schskp_out_error();

  /*         Setup a Vgroup         */
  if ((vgrp_id_schskp_out = Vattach(hdf_fp, -1, "w"))==FAIL) {
    print_schskp_out_error("init_cr_schskp_out -> Vattach: Couldn't create Vgroup");
    retval = -1;
  }
  Vsetname(vgrp_id_schskp_out, "VG_schskp_outData"); 
  Vsetclass(vgrp_id_schskp_out, "VG_schskp_out");


  /*      Get the Vgroup reference     */
  if ((vgrp_ref_w = Vfind(hdf_fp, "VG_schskp_outData" )) ==FAIL) {
    print_schskp_out_error("init_cr_schskp_out -> Vfind: Couldn't get Vgrp reference");
    retval = -1;
  }
  /*      Add a description to the Vgroup      */
  wr_Vgrp_desc_schskp_out(Vgrp_descrp_schskp_outData);

  if ((ann_id_w = ANcreate(an_id, DFTAG_VG, vgrp_ref_w, AN_DATA_DESC)) ==FAIL) {
    print_schskp_out_error("init_cr_schskp_out -> ANcreate: Can't create Vgrp description");
    retval = -1;
  }
  if ((ANwriteann(ann_id_w, Vgrp_descrp_schskp_outData, sizeof(Vgrp_descrp_schskp_outData))) ==FAIL) {
    print_schskp_out_error("init_cr_schskp_out -> ANwriteann: Can't write Vgrp description");
    retval = -1;
  }
  ANendaccess(ann_id_w);

  /*        Setup a Vdata        */
  if ((vdata_id_schskp_out = VSattach(hdf_fp, -1, "w")) ==FAIL) {
    print_schskp_out_error("init_cr_schskp_out -> VSattach: Couldn't attach to Vdata");
    retval = -1;
  }
  VSsetname(vdata_id_schskp_out, "SCHskpData");
  VSsetclass(vdata_id_schskp_out, classname);

  /*       Insert the Vdata into the Vgroup       */
  if ((Vinsert(vgrp_id_schskp_out, vdata_id_schskp_out)) ==FAIL) {
    print_schskp_out_error("init_cr_schskp_out -> Vinsert: Couldn't insert Vdata into Vgroup");
    retval = -1;
  }

  /*    Define the fields in the Vdata    */
  if (VSfdefine(vdata_id_schskp_out, "sc_clk", DFNT_UINT32, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define sc_clk");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "TankA1Temp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define TankA1Temp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "TankA2Temp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define TankA2Temp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "TankB1Temp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define TankB1Temp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "TankB2Temp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define TankB2Temp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "LinesATemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define LinesATemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "LinesBTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define LinesBTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "LinesPosXTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define LinesPosXTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "LinesNegXTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define LinesNegXTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "StarTrkTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define StarTrkTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "InstDeckTemp1", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define InstDeckTemp1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "InstDeckTemp2", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define InstDeckTemp2");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "InstDeckTemp3", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define InstDeckTemp3");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "InstDeckTemp4", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define InstDeckTemp4");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "InstDeckTemp5", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define InstDeckTemp5");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "InstDeckTemp6", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define InstDeckTemp6");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "InstDeckTemp7", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define InstDeckTemp7");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "InstDeckTemp8", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define InstDeckTemp8");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "LastSPTT0", DFNT_UINT8, (3) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define LastSPTT0");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "ScIFHeaterCur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define ScIFHeaterCur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "SunSnsrTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define SunSnsrTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "PosXSAPTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define PosXSAPTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "PosXSAPHTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define PosXSAPHTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "NegXSAPTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define NegXSAPTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "NegXSAPHTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define NegXSAPHTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "MagInTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define MagInTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "MagOutTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define MagOutTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "MagInHtrPwrLvl", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define MagInHtrPwrLvl");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "MagOutHtrPwrLvl", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define MagOutHtrPwrLvl");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "S3DPUPwrCvtVolt", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define S3DPUPwrCvtVolt");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "PwrSubProACur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define PwrSubProACur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "PwrSubProBCur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define PwrSubProBCur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "AxialThrstCur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define AxialThrstCur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Channel25", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Channel25");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Channel26", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Channel26");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Channel20", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Channel20");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Channel30", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Channel30");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "DigTellLog0", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define DigTellLog0");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "DigTellLog1", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define DigTellLog1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "data_2_1", DFNT_UINT8, (16) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define data_2_1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "MagSenIntTempPosY", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define MagSenIntTempPosY");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "MagSenIntTempNegY", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define MagSenIntTempNegY");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "data_2_2", DFNT_UINT8, (2) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define data_2_2");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "data_3_1", DFNT_UINT8, (10) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define data_3_1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "MainBusCur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define MainBusCur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "MainBusVolt", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define MainBusVolt");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "data_3_2", DFNT_UINT8, (8) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define data_3_2");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "data_4_1", DFNT_UINT8, (20) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define data_4_1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "data_5_1", DFNT_UINT8, (20) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define data_5_1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "data_6_1", DFNT_UINT8, (20) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define data_6_1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "data_7_1", DFNT_UINT8, (20) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define data_7_1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "data_8_1", DFNT_UINT8, (17) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define data_8_1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "LastSPTT8", DFNT_UINT8, (3) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define LastSPTT8");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "SwepamE_8VPSMon", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define SwepamE_8VPSMon");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "SwepamE_HVMon1", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define SwepamE_HVMon1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "SwepamE_HVMon2", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define SwepamE_HVMon2");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "SwepamI_8VPSMon", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define SwepamI_8VPSMon");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "SwepamI_HVMon1", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define SwepamI_HVMon1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "SwepamI_HVMon2", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define SwepamI_HVMon2");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Epam_A1", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Epam_A1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Epam_A2", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Epam_A2");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Epam_A3", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Epam_A3");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Epam_A4", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Epam_A4");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Epam_LAN1", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Epam_LAN1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Epam_LAN2A", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Epam_LAN2A");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Epam_LAN2B", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Epam_LAN2B");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Uleis_LVPSVolt", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Uleis_LVPSVolt");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Cris_IntTemp1", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Cris_IntTemp1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Cris_IntTemp2", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Cris_IntTemp2");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Sis_IntTemp1", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Sis_IntTemp1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Sis_IntTemp2", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Sis_IntTemp2");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "SunPulPhaAng0", DFNT_UINT16, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define SunPulPhaAng0");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "data_10_1", DFNT_UINT8, (2) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define data_10_1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "data_10_2", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define data_10_2");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Cris_Cur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Cris_Cur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Sis_Cur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Sis_Cur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Epam_Cur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Epam_Cur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Epam_HtrCur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Epam_HtrCur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Uleis_Cur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Uleis_Cur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Uleis_AnaEleLVPSCur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Uleis_AnaEleLVPSCur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "DCM1_Chan21", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define DCM1_Chan21");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Uleis_HtrCur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Uleis_HtrCur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "SwepamE_Cur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define SwepamE_Cur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "SwepamI_Cur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define SwepamI_Cur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Swims_Cur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Swims_Cur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Swics_Cur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Swics_Cur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Sepica_Cur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Sepica_Cur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Mag_Cur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Mag_Cur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "S3DPU_Cur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define S3DPU_Cur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "data_10_3", DFNT_UINT8, (2) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define data_10_3");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "PowSwiOrdBit", DFNT_UINT8, (14) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define PowSwiOrdBit");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "data_11_1", DFNT_UINT8, (4) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define data_11_1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "S3DPU_ConSecCur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define S3DPU_ConSecCur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "PreTraCur", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define PreTraCur");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Swims_IntTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Swims_IntTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Swics_IntTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Swics_IntTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Uleis_TelTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Uleis_TelTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Uleis_AnaEleTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Uleis_AnaEleTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Uleis_DPUTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Uleis_DPUTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "Sepica_IsoTanTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define Sepica_IsoTanTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "S3DPU_PowSupATemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define S3DPU_PowSupATemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "SwepamE_IntTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define SwepamE_IntTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "SwepamI_IntTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define SwepamI_IntTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "StarScan", DFNT_UINT8, (8) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define StarScan");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "TermBoardFuse1Temp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define TermBoardFuse1Temp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "data_12_1", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define data_12_1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "S3DPU_PowSupBTemp", DFNT_UINT8, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define S3DPU_PowSupBTemp");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "CDH_HKdat", DFNT_UINT8, (48) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define CDH_HKdat");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "data_15_1", DFNT_UINT8, (10) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define data_15_1");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "SunPulPhaAng8", DFNT_UINT16, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define SunPulPhaAng8");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "SelTelByt", DFNT_UINT8, (16) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define SelTelByt");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "SCIPhaAng", DFNT_UINT16, (16) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define SCIPhaAng");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "FormatID", DFNT_UINT8, (16) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define FormatID");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "CollForm", DFNT_UINT8, (16) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define CollForm");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "ADCPhaAng", DFNT_UINT16, (1) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define ADCPhaAng");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "SunSensor", DFNT_UINT16, (11) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define SunSensor");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "ADCXtrDat", DFNT_UINT8, (51) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define ADCXtrDat");
    retval = -1;
  }
  if (VSfdefine(vdata_id_schskp_out, "spare", DFNT_UINT8, (17) )) {
    print_schskp_out_error("init_cr_schskp_out -> VSfdefine: Couldn't define spare");
    retval = -1;
  }

  if (VSsetfields(vdata_id_schskp_out,"sc_clk, TankA1Temp, TankA2Temp, TankB1Temp, TankB2Temp, LinesATemp, LinesBTemp, LinesPosXTemp, LinesNegXTemp, StarTrkTemp, InstDeckTemp1, InstDeckTemp2, InstDeckTemp3, InstDeckTemp4, InstDeckTemp5, InstDeckTemp6, InstDeckTemp7, InstDeckTemp8, LastSPTT0, ScIFHeaterCur, SunSnsrTemp, PosXSAPTemp, PosXSAPHTemp, NegXSAPTemp, NegXSAPHTemp, MagInTemp, MagOutTemp, MagInHtrPwrLvl, MagOutHtrPwrLvl, S3DPUPwrCvtVolt, PwrSubProACur, PwrSubProBCur, AxialThrstCur, Channel25, Channel26, Channel20, Channel30, DigTellLog0, DigTellLog1, data_2_1, MagSenIntTempPosY, MagSenIntTempNegY, data_2_2, data_3_1, MainBusCur, MainBusVolt, data_3_2, data_4_1, data_5_1, data_6_1, data_7_1, data_8_1, LastSPTT8, SwepamE_8VPSMon, SwepamE_HVMon1, SwepamE_HVMon2, SwepamI_8VPSMon, SwepamI_HVMon1, SwepamI_HVMon2, Epam_A1, Epam_A2, Epam_A3, Epam_A4, Epam_LAN1, Epam_LAN2A, Epam_LAN2B, Uleis_LVPSVolt, Cris_IntTemp1, Cris_IntTemp2, Sis_IntTemp1, Sis_IntTemp2, SunPulPhaAng0, data_10_1, data_10_2, Cris_Cur, Sis_Cur, Epam_Cur, Epam_HtrCur, Uleis_Cur, Uleis_AnaEleLVPSCur, DCM1_Chan21, Uleis_HtrCur, SwepamE_Cur, SwepamI_Cur, Swims_Cur, Swics_Cur, Sepica_Cur, Mag_Cur, S3DPU_Cur, data_10_3, PowSwiOrdBit, data_11_1, S3DPU_ConSecCur, PreTraCur, Swims_IntTemp, Swics_IntTemp, Uleis_TelTemp, Uleis_AnaEleTemp, Uleis_DPUTemp, Sepica_IsoTanTemp, S3DPU_PowSupATemp, SwepamE_IntTemp, SwepamI_IntTemp, StarScan, TermBoardFuse1Temp, data_12_1, S3DPU_PowSupBTemp, CDH_HKdat, data_15_1, SunPulPhaAng8, SelTelByt, SCIPhaAng, FormatID, CollForm, ADCPhaAng, SunSensor, ADCXtrDat, spare")){
    print_schskp_out_error("init_cr_schskp_out -> VSsetfields: Couldn't set fields");
    retval = -1;
  }
...
int32 init_wr_schskp_out(int32 hdf_fp, int32 sd_id, int32 an_id, char *classname)
{ return( init_cr_schskp_out(hdf_fp, sd_id, an_id, classname) ); }

/******---- write function ----******/

int32 write_schskp_out(struct SCHskpData SCHskpData_struc, int32 recnum)
{
  int32 retval = 0;
  uint8 *odata;

void print_schskp_out_error();
void pack_schskp_out();

  odata = (uint8 *) malloc(sizeof(struct SCHskpData));
  pack_schskp_out(odata, &SCHskpData_struc);

  if(recnum!=-1) {
	if(VSseek(vdata_id_schskp_out, recnum)==-1) {
		print_schskp_out_error("write_schskp_out -> VSseek: error.");
		retval = -1;
	}
  }
  if(VSwrite(vdata_id_schskp_out, (uint8 *)odata, 1, FULL_INTERLACE) == -1)
    print_schskp_out_error("write_schskp_out -> VSwrite: Couldn't write data.");
...
void close_wr_schskp_out()
{
  VSdetach(vdata_id_schskp_out);
  Vdetach(vgrp_id_schskp_out);
}

/*----     init access function    ----*/

int32 init_acc_schskp_out(int32 hdf_fp, int32 sd_id, char *access_mode)
{
  int32 vdata_ref;
  int32 num_rec;
  ...
  if ((vdata_ref = VSfind(hdf_fp, "SCHskpData")) <= 0) {
    print_schskp_out_error("init_acc_schskp_out -> VSfind: Found no vdata of specified type");
    return(0);
  }
  if ((vdata_id_schskp_out = VSattach(hdf_fp, vdata_ref, access_mode)) ==FAIL) {
    print_schskp_out_error("init_acc_schskp_out -> VSattach: Couldn't attach to hdf file.");
    return(-1);
  }

  VSinquire(vdata_id_schskp_out, &num_rec, NULL, NULL, NULL, NULL);
  if (num_rec == 0) { return(0); }


  if (VSsetfields(vdata_id_schskp_out,"sc_clk, TankA1Temp, TankA2Temp, TankB1Temp, TankB2Temp, LinesATemp, LinesBTemp, LinesPosXTemp, LinesNegXTemp, StarTrkTemp, InstDeckTemp1, InstDeckTemp2, InstDeckTemp3, InstDeckTemp4, InstDeckTemp5, InstDeckTemp6, InstDeckTemp7, InstDeckTemp8, LastSPTT0, ScIFHeaterCur, SunSnsrTemp, PosXSAPTemp, PosXSAPHTemp, NegXSAPTemp, NegXSAPHTemp, MagInTemp, MagOutTemp, MagInHtrPwrLvl, MagOutHtrPwrLvl, S3DPUPwrCvtVolt, PwrSubProACur, PwrSubProBCur, AxialThrstCur, Channel25, Channel26, Channel20, Channel30, DigTellLog0, DigTellLog1, data_2_1, MagSenIntTempPosY, MagSenIntTempNegY, data_2_2, data_3_1, MainBusCur, MainBusVolt, data_3_2, data_4_1, data_5_1, data_6_1, data_7_1, data_8_1, LastSPTT8, SwepamE_8VPSMon, SwepamE_HVMon1, SwepamE_HVMon2, SwepamI_8VPSMon, SwepamI_HVMon1, SwepamI_HVMon2, Epam_A1, Epam_A2, Epam_A3, Epam_A4, Epam_LAN1, Epam_LAN2A, Epam_LAN2B, Uleis_LVPSVolt, Cris_IntTemp1, Cris_IntTemp2, Sis_IntTemp1, Sis_IntTemp2, SunPulPhaAng0, data_10_1, data_10_2, Cris_Cur, Sis_Cur, Epam_Cur, Epam_HtrCur, Uleis_Cur, Uleis_AnaEleLVPSCur, DCM1_Chan21, Uleis_HtrCur, SwepamE_Cur, SwepamI_Cur, Swims_Cur, Swics_Cur, Sepica_Cur, Mag_Cur, S3DPU_Cur, data_10_3, PowSwiOrdBit, data_11_1, S3DPU_ConSecCur, PreTraCur, Swims_IntTemp, Swics_IntTemp, Uleis_TelTemp, Uleis_AnaEleTemp, Uleis_DPUTemp, Sepica_IsoTanTemp, S3DPU_PowSupATemp, SwepamE_IntTemp, SwepamI_IntTemp, StarScan, TermBoardFuse1Temp, data_12_1, S3DPU_PowSupBTemp, CDH_HKdat, data_15_1, SunPulPhaAng8, SelTelByt, SCIPhaAng, FormatID, CollForm, ADCPhaAng, SunSensor, ADCXtrDat, spare")) {
      print_schskp_out_error("init_acc_schskp_out -> VSsetfields: Unable to set fields.");
      return(-1);
  }
  return(num_rec);
}
...
int32 init_rd_schskp_out(int32 hdf_fp, int32 sd_id, char *access_mode)
{ return ( init_acc_schskp_out(hdf_fp, sd_id, access_mode) ); }

/******---- read function ----******/

int32 read_schskp_out(struct SCHskpData *SCHskpData_struc, int32 recnum_rd)
{
...
void print_schskp_out_error();
void unpack_schskp_out();

  if(recnum_rd==-1) recnum_rd=last_recnum+1;

  odata = (uint8 *) malloc(sizeof(struct SCHskpData));
  VSinquire(vdata_id_schskp_out, &maxrec, NULL, NULL, NULL, NULL);
  if (recnum_rd >= maxrec) return(-1);
  if (recnum_rd != last_recnum+1)
      if (VSseek(vdata_id_schskp_out, recnum_rd)==FAIL) {
          print_schskp_out_error("read_schskp_out -> VSseek unsuccessful");
          retval = -1;
    }
  last_recnum = recnum_rd;

  if(VSread(vdata_id_schskp_out, (uint8 *)odata, 1, FULL_INTERLACE) ==FAIL) {
    print_schskp_out_error("read_schskp_out -> VSread: Couldn't read data.");
    retval = -1;
  }
  unpack_schskp_out(odata, SCHskpData_struc);
  free(odata);
  return(retval);
}
...
void close_rd_schskp_out()
{
  VSdetach(vdata_id_schskp_out);
}

/*----  Read V group description, function    ----*/
void rd_Vgrp_desc_schskp_out(int32 hdf_fp, int32 an_id)
{
  int32 ann_id_r;
  int32 num_ann;
  int32 *ann_list;
...
void print_schskp_out_error();
  ...
  /*      Get the Vgroup reference     */
  if ((vgrp_ref_r = Vfind(hdf_fp, "VG_schskp_outData" )) ==FAIL)
    print_schskp_out_error("rd_Vgrp_schskp_out -> Vfind: Couldn't get Vgrp reference.");

  if ((num_ann = ANnumann(an_id, AN_DATA_DESC, DFTAG_VG, vgrp_ref_r)) ==FAIL)
    print_schskp_out_error("rd_Vgrp_schskp_out -> ANnumann: Couldn't get number of annotations.");

printf("1numann= %d \n", num_ann);
    ann_list = HDmalloc(num_ann * sizeof(int32));
printf("1ann_list= %d \n", ann_list);
  if ((num_ann = ANannlist(an_id, AN_DATA_DESC, DFTAG_VG, vgrp_ref_r, ann_list)) ==FAIL)
    print_schskp_out_error("rd_Vgrp_schskp_out -> ANannlist: Couldn't");

printf("2numann= %d \n", num_ann);
printf("2ann_list= %d \n", ann_list);
  if ((ann_id_r = ANselect(an_id, (num_ann-1), AN_DATA_DESC)) ==FAIL)
    print_schskp_out_error("rd_Vgrp_schskp_out -> ANselect: Couldn't");

  if (ANreadann(ann_id_r, Vgrp_descrp_schskp_outData, HDstrlen(Vgrp_descrp_schskp_outData)) ==FAIL)
    print_schskp_out_error("rd_Vgrp_schskp_out -> ANreadann: Couldn't");

  printf("AN: %s\n", Vgrp_descrp_schskp_outData);
...
void print_schskp_out_error(int8 *mess)
{
  fprintf(stderr,"\nERROR in  hdf_schskp_out.c -> %s\n", mess);
  HEprint(stderr, 0);
}

/*----   pack function    ----*/

void pack_schskp_out(uint8 *data, struct SCHskpData *SCHskpData_ptr)
{
int32 ptr=0;
...
void unpack_schskp_out(uint8 *data, struct SCHskpData *SCHskpData_ptr)
{
int32 ptr=0;
...
int32 get_vgrp_id_schskp_out() {return(vgrp_id_schskp_out);}

/*----   V group description function    ----*/

int32 wr_Vgrp_desc_schskp_out(char *wr_strval)
{
  strcat(wr_strval, "The file 'schskp.h' is shown below, it was used to create the data in the Vgroup named 'VG_schskp_outData'.\n\n");
