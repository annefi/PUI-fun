#include "analyse_testdata.h"

/*
  Revision controlled by SVN:
  $Id: analyse_data.cc 4822 2007-08-10 14:05:59Z berger $
*/
...
int main()
{
  ...
  char version[]="$Id$";
  string thisprogram = "analyse_testdata : ";
  string filenamelist ="";
  string filenamedata ="";
  ...
  printf("analyse_testdata -I- analyses ACE/SWICS artifical data. produces Lv1 data,\n");
  printf("          built %s %s\n",__DATE__,__TIME__);
  printf("          from %s\n",version);

  // Read ion_pos.in -> several settings are done
  
  string filenameionposin = "analyse_testdata.in";
  ...
  filenameergin="testpara30_1000.dat";
