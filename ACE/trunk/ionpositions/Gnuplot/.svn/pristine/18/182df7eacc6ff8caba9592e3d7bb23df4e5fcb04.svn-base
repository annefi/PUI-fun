...
class PlotItem:
    ...
    _option_list = {
        ...
        'linetype' : lambda self, lt: self.set_string_option(
            'linetype', lt, None, 'lt %s')
        }
    ...
    # special colonsep options:
    def setTitle(self, tit):
        self.set_option_colonsep("title", '"%s"' % tit)
