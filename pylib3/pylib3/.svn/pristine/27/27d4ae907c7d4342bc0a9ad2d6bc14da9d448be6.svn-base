...
import pylab
from pylib3.dbData._plotmod import PlotMod
from pylib3.dbData._datacontainer import DataContainer
from pylib3.etMisc import loading_bar
...
class PlotdbData(object):
    ...
    def __prepare_timeseries(self, P, smask, Master):
        ...
        if smask:
            ...
            validmasks = list(self.db.mask.keys())
    ...
    def hist1d(self, prod,binx=50,norm=False,smask=False,weights=False,Master=True,xlabel=False,ylabel=False,legend=True,legendbox=True, avg=False):
    ...
    def hist2d(self, prodx, prody, prodz=False, binx=50, biny=50, norm=False, cb=False, weights=False, smask=False, ncols=False, Master=True, xlabel=False, ylabel=False, rot_xticks=True, style = "both", shade=False, clines=10, avg=False):
        ...
        for kindex, key in enumerate(validmasks):
            ...
            if style == "both":
                ...
                pylab.clabel(MeshL, fontsize=9, inline=True, fmt="%4.1f")
